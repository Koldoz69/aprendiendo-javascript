...
function comprarCursos(e) {
    ...
    if(e.target.classList.contains('agregar-carrito')) {
        ...
        //curso seleccionado para todos los datos
...
function guardarCursosLocalStorage(curso) {
    let cursos;
    //toma los datos de un arreglo con datos de LS a vacio
...
function eliminarCursoLocalStorage(curso) {
    ...
    //Iteramos comparando el ID del cursos borrado con los del LS
